    ...
    jet.extend(jeDatePick.prototype,{
        init : function () {  
            ...
            if(!isShow || !trigges){  
                ...
                if (trigges) {
                    (function(that, trigges, opts){
                        that.valCell['on' + trigges] = function(){
        ...
        methodEventBind : function() {
            ...
            jet.extend(that,{
                ...
                monthClick:function (val) {
                    ...
                    that.renderDate();
                    if(opts.format === 'YYYY-MM' && !opts.onClose) {
                        var newArr = [];
                        newArr[0] = {YYYY: parseInt(that.selectDate[0].YYYY), MM:parseInt(that.selectDate[0].MM), DD:dateD}
